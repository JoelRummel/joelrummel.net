const WORK_EXPERIENCE = [
    ...
    },
    {
        ...
        shortDescription: "I developed an internal app for web and mobile to serve as the sljf sdl fksjf lskfjs fewfiajs ds xmvn x,mnsw oefjsdfj slfjslefjsdkfj slk.",
        longDescription: "Long description here.",
        skills: [
            {
                label: "Tech",
